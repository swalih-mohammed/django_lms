...
const Certificate = (props) => {
  ...
  const progress1 = isNaN(progress) ? 0 : progress;
  const prgressPercentage = progress1 === 0 ? 0 : Math.round(progress1 * 100);
  return (
    <Card
      mode="elevated"
      style={{
      ...
      {progress != 1 && (
        ...
        >
          ...
          >
            ...
            >
              <ProgressBar progress={progress1} color={COLORS.primary} />
            </View>
